...
@(private = "file")
RELOAD_ARTIFACT_A :: "funpack-artifact 10\n" +
	"[meta 2]\n" +
	"project mig\n" +
	"version L5:0.1.0\n" +
	"[data 2]\n" +
...
@(private = "file")
RELOAD_ARTIFACT_B :: "funpack-artifact 10\n" +
	"[meta 2]\n" +
	"project mig\n" +
	"version L5:0.1.0\n" +
	"[data 2]\n" +
...
@(private = "file")
RELOAD_ARTIFACT_B_GHOST :: "funpack-artifact 10\n" +
	"[meta 2]\n" +
	"project mig\n" +
	"version L5:0.1.0\n" +
	"[data 2]\n" +
...
@(private = "file")
RELOAD_ARTIFACT_B_NEW_THING :: "funpack-artifact 10\n" +
	"[meta 2]\n" +
	"project mig\n" +
	"version L5:0.1.0\n" +
	"[data 2]\n" +
