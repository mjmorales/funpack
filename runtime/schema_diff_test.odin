...
//
// PROVENANCE — a deliberate copy of funpack/schema_diff_test.odin, the
// kernel-copy audit vectors the runtime side re-asserts per schema_diff.odin's
// bit-identity obligation. The builder helpers are file-private here so the
// copied names never widen the runtime package surface.
