...
@(private = "file")
MIG_ARTIFACT_A :: "funpack-artifact 11\n" +
	"[meta 2]\n" +
	"project mig\n" +
	"version L5:0.1.0\n" +
	"[data 2]\n" +
...
@(private = "file")
MIG_ARTIFACT_B :: "funpack-artifact 11\n" +
	"[meta 2]\n" +
	"project mig\n" +
	"version L5:0.1.0\n" +
	"[data 2]\n" +
...
@(private = "file")
MIG_ARTIFACT_B_GHOST :: "funpack-artifact 11\n" +
	"[meta 2]\n" +
	"project mig\n" +
	"version L5:0.1.0\n" +
	"[data 1]\n" +
...
@(private = "file")
MIG_ARTIFACT_B_SILENT_RETYPE :: "funpack-artifact 11\n" +
	"[meta 2]\n" +
	"project mig\n" +
	"version L5:0.1.0\n" +
	"[data 1]\n" +
