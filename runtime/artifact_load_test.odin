...
test_load_version_gate :: proc(t: ^testing.T) {
	...
	// A FUTURE version (v13) is equally a mismatch — the gate is exact, not
	// floor-or-ceiling.
	future_version := "funpack-artifact 13\n[meta 0]\n"
...
V5_ARTIFACT :: "funpack-artifact 12\n" +
	"[meta 2]\n" +
	"project yard\n" +
	"version L5:0.1.0\n" +
	"[enums 1]\n" +
...
test_load_v5_malformed_refused :: proc(t: ^testing.T) {
	...
	unknown_section := "funpack-artifact 12\n[meta 2]\nproject yard\nversion L5:0.1.0\n[gravity 0]\n"
