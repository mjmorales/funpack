// Code generated by `funpack mcp gen-contract`; DO NOT EDIT.
//
// Source of truth: contract/funpack-api.json. Regenerate with the Odin-native
// `funpack mcp gen-contract` verb (cmd/funpack/cli_mcp_gen_contract.odin).
package funpack
